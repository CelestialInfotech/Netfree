...
// import { Search, Grid, LogOut, User, X } from 'lucide-react'
...
//             <Link href="/allmovies" className="link-nav">Movies</Link>
//             <Link href="/shows" className="link-nav">TV Shows</Link>
//             <Link href="/watchlist" className="link-nav">Watch List</Link>
//           </div>
...
//                   className="w-10 h-10 bg-primary rounded-full flex items-center justify-center hover:bg-primary-hover transition-smooth"
//                 >
//                   <User size={20} className="text-white" />
//                 </button>

//                 {showMenu && (
//                   <div className="absolute right-0 mt-2 w-48 bg-surface border border-surface-secondary rounded-lg shadow-xl py-2 z-50">
//                     <div className="px-4 py-2 border-b border-surface-secondary">
